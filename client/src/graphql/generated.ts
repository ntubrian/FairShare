...
export type ProjectExpensesQuery = { __typename?: 'Query', expenses: Array<{ __typename?: 'Expense', id: string, projectId: string, payerId: string, amount: number, currency: Currency, splitMode: SplitMode, description?: string | null, occurredAt: string, createdAt: string, updatedAt: string, payer?: { __typename?: 'Participant', id: string, name: string } | null, splits: Array<{ __typename?: 'ExpenseSplit', participantId: string, amount?: number | null, shares?: number | null, participant?: { __typename?: 'Participant', id: string, name: string } | null }> }> };
