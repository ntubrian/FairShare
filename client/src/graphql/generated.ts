...
export type ProjectDetailQuery = { __typename?: 'Query', project?: { __typename?: 'Project', id: string, name: string, targetCurrency: string, agreedRateFirst: boolean, status: ProjectStatus, members: Array<{ __typename?: 'ProjectMember', userId: string, role: MemberRole, user?: { __typename?: 'User', id: string, displayName: string, email: string, accountRole: MemberRole } | null }> } | null };
